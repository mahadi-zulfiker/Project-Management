        ...
        <div className='flex items-center justify-between bg-white px-4 py-3 dark:bg-black'>
            ...
            <div className='flex items-center gap-8'>
                ...
                {!isSidebarCollapsed ? null : (
                    <button onClick={() => dispatch(setIsSidebarCollapsed(!isSidebarCollapsed))} className='h-8 w-8 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center'>
                        <Menu className='h-8 w-8 dark:text-white'/>
                    </button>
                )}
                <div className='relative flex h-min w-[200px]'>
                    <Search className="absolute left-[4px] top=1/2 mr-2 h-5 mt-4 w-5 -translate-y-1/2 transform cursor-pointer dark:text-white" />
